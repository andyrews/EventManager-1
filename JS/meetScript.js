...
function verifyOtherAddValues(datesstart, dateend, addCheckboxes) {
...
async function createMeeting() {
	...
	if (verifyOtherAddValues(dateStartCell, dateEndCell, addCheckboxes) !== "") {
...
saveEditBtn.forEach((b) => {//editMeeting
	b.addEventListener('click', () => {
		...
		const verified = verifyOtherAddValues(meetingStartTime, meetingEndTime, meetingRoles)
		if (verified === '') {
